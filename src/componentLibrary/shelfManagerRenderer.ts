...
import { ShelfRenderer } from "./shelfRenderer.ts";

/**
 * Manages rendering of multiple shelves with proper layering
 */
export class ShelfManagerRenderer implements IRenderer {
  private shelfRenderers: ShelfRenderer[];

  /**
   * @param shelfRenderers Array of all shelf renderers to manage
   */
  constructor(shelfRenderers: ShelfRenderer[]) {
   ...
   */
  public addShelfRenderer(renderer: ShelfRenderer): void {
   ...
   */
  public removeShelfRenderer(renderer: ShelfRenderer): void {
