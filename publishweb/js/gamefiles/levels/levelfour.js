...
import { CheckoutRoom, CleaningRoom, DeliveryRoom, FoodRoom, HousingRoom, PharmaRoom } from "../scenes/roomData.js";
...
export function loadLevelFour(gameEngine, sceneManager, ctx, inventoryManager, orderLoop, bossSatisfaction) {
    // Create rooms
